...
/**
 * This class is to test sequence of PLACE commands and assert the context
 * The test class is parameterized and takes its input from resource file src/test/resources/place_command_test.csv
 * It takes two values
...
public class PlaceCommandTest extends  BaseCommandTest{
     ...
     */
    @ParameterizedTest
    @CsvFileSource(resources = "/place_command_test.csv")
