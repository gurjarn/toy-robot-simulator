...
/**
 * This class is to test sequence of MOVE commands and assert the context
 * The test class is parameterized and takes its input from resource file src/test/resources/move_command_test.csv
 * It takes two values
...
public class MoveCommandTest extends BaseCommandTest{
     ...
     */
    @ParameterizedTest
    @CsvFileSource(resources = "/move_command_test.csv")
